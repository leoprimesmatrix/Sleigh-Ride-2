    ...
    <div className="absolute inset-0 bg-black z-50 flex flex-col items-center justify-center overflow-hidden font-mono text-white">
      ...
      {stage < 2 && (
          <div className="relative flex items-center justify-center animate-pulse">
             <div className="absolute w-[500px] h-[500px] border-4 border-cyan-500 rounded-full animate-[spin-slow_10s_linear_infinite] opacity-50 shadow-[0_0_50px_rgba(6,182,212,0.3)]"></div>
             ...
             <div className="text-center z-10">
                 <Clock size={64} className="mx-auto mb-4 text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,1)]" />
      ...
      <div className={`absolute inset-0 bg-[#020617] flex flex-col items-center justify-center transition-opacity duration-1000 ${stage >= 3 ? 'opacity-100' : 'opacity-0'}`}>
          <p className="text-xl text-cyan-100 italic mb-8 max-w-lg text-center leading-relaxed drop-shadow-[0_0_5px_rgba(34,211,238,0.5)]">
              "History is gone. So I will rewrite it."
          </p>
          
          {stage >= 4 && (
            <div className="mt-8 text-center animate-fade-in-up">
                <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]">YEAR 0</h1>
